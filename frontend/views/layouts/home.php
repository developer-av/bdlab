        ...
        <div class="page-wrapper">
            <header>
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="logo"><a href="<?= Url::to(['/']); ?>"><img src="/img/logo.png" alt=""></a></div>
                        </div>
                    ...
                    <div class="row absol">
                        <div class="col-md-6 col-md-offset-3">
                            <h2>Полный спектр услуг <br>
                                для создания и продвижения <br>
                                Вашего бизнеса
                            </h2>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="ready">
                                <p>
                                    <span>
                                        Вы готовы обсудить Ваш проект <br>
                                        с нашими специалистами?
                                    </span>
                                </p><br>
                                <p>
                                    Отлично! Свяжитесь с нами, и мы с удовольствием  <br>
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <a target="_blank" href="https://vk.com/lab4biz"><img src="/img/VK.png" alt=""></a><a target="_blank" href="https://www.facebook.com/laboratory4biz"><img src="/img/facebook.png" alt=""></a>
                                </div>
                            </div>
                            <br>
                            <div class="row">
