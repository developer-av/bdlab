...
use common\modules\clients\backend\widgets\imgareaselect\ImgAreaSelect;
use xj\imgareaselect\ImgareaselectAsset;
use common\modules\clients\backend\AppAsset;
...
<div class="services-form">
    ...
    <div style="max-width: 600px; margin: 0 auto;" class="text-center">
        ...
        <label id="dropzone" for="uploadimage" class="dropzone text-muted">
            ...
            <br/>
            Перетащите сюда фотографию, или нажмите чтобы загрузка ее.
            <br/>
